package oop.kevin.clients.search.functional.gui;
...
import oop.kevin.clients.search.data.TaskData;
import oop.kevin.clients.search.entity.Task;
import oop.kevin.clients.search.functional.BaseSeleniumTestCase;
...
public class TaskGuiFT extends BaseSeleniumTestCase {
	...
	public void viewTaskList() {
		...
		assertEquals("Release haixue-server 1.0", s.getTable(table, 0, 0));
	}
