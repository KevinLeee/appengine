package oop.kevin.clients.datasync.demos.mail;
...
import oop.kevin.clients.datasync.demos.utilities.email.MimeMailService;
import oop.kevin.clients.datasync.demos.utilities.email.SimpleMailService;
...
public class MailServiceTest extends SpringContextTestCase {
	...
	public void sendSimpleMail() throws MessagingException, InterruptedException, IOException {
		...
		assertEquals("jira@sunland.org.cn", message.getFrom()[0].toString());
