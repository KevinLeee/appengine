package oop.kevin.clients.datasync.webservice.soap;
...
import oop.kevin.clients.datasync.service.AccountEffectiveService;
import oop.kevin.clients.datasync.webservice.soap.response.GetTeamDetailResult;
...
import oop.kevin.clients.datasync.webservice.soap.response.dto.TeamDTO;
import oop.kevin.clients.datasync.webservice.soap.response.dto.UserDTO;
import oop.kevin.service.beanvalidator.BeanValidators;
import oop.kevin.service.mapper.BeanMapper;
import oop.kevin.service.utils.Exceptions;
...
@WebService(serviceName = "AccountService", endpointInterface = "oop.kevin.clients.datasync.webservice.soap.AccountSoapService", targetNamespace = WsConstants.NS)
