package oop.kevin.clients.datasync.demos.utilities.email;
...
public class MimeMailService {
	...
	public void sendNotificationMail(String userName) {
		...
		try {
			...
			helper.setTo("jira@sunland.org.cn");
			helper.setFrom("jira@sunland.org.cn");
			...
			mailSender.send(msg);
			logger.info("HTML版邮件已发送至jira@sunland.org.cn");
