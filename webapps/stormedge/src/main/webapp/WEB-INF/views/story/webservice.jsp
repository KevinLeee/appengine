...
<h2>1. 传统的SOAP Web Service演示</h2>
<ul>
    <li>服务端是基于CXF的JAX-WS演示, 见CXF自动生成的<a href="${ctx}/cxf/">wsdl文件列表</a></li>
    <li>客户端见Functional Test用例, 或SoapUI工具.</li>
</ul>

<h2>2. 基于JAX-RS标准的Restful演示</h2>
<ul>
    <li>服务端是基于CXF的JAX-WS演示, CXF自动生成的<a href="${ctx}/cxf/">wadl文件列表</a></li>
    <li>演示地址：<a href="${ctx}/cxf/jaxrs/user/1.xml">/cxf/jaxrs/user/1.xml</a> 与 <a href="${ctx}/cxf/jaxrs/user/1.json">/cxf/jaxrs/user/1.json</a>
    </li>
</ul>
...
<ul>
    ...
    <li>XML与JSON两种格式的序列化，根据Url自动判定Content-Type</li>
    <li>演示地址：<a href="${ctx}/api/v1/user/1.xml">/api/v1/user/1.xml</a> 与 <a href="${ctx}/api/v1/user/1.json">/api/v1/user/1.json</a>
